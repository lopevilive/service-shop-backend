...
const {ERR_CODE_MAP: { CODE_PERMISSION_ERR}} = require(path.join(process.cwd(),"util/errCode"))
...
module.exports.authMap = {
  albumService: require('./author-rules/albumRules'),
  userService: require('./author-rules/albumRules'),
  oilService: require('./author-rules/oilRules')
}
