...
module.exports = {
  ...
  columns: {
    ...
    type3D: {type: 'int', nullable: true}, // 0-无、1-默认、2-url  弃用
    model3D: {type: 'int', nullable: true}, // 1-衣柜、2-地板、3-瓷砖 弃用
    modelUrl: {type: 'varchar', nullable: true}, // 弃用
    fields: {type: 'varchar', nullable: true}, // 行业个性字段 弃用
